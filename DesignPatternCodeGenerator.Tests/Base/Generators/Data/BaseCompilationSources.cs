...
public static class BaseCompilationSources
{
    ...
    public static IEnumerable<object[]> GetSampleDataContainerUsingsAndNamespace()
    {
        yield return new object[] { _inputSourcePublicClass, _containerUsingAndNamespace };
    }
...
namespace Test.Test";
    ...
    private static readonly string _containerUsingAndNamespace =
        @"// <auto-generated/>
